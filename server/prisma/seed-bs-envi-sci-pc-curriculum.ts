...
const curriculumData = [
  ...
  { yearLevel: 1, semester: 1, courseCode: 'PE 1', subjectName: 'Path Fit 1', lec: 2, lab: 0, totalUnits: 2, lecHours: 2, labHours: 0, totalHours: 2, prerequisites: [] },
  ...
  { yearLevel: 1, semester: 2, courseCode: 'BIO 102', subjectName: 'Biodiversity and Evolution Lec', lec: 3, lab: 0, totalUnits: 3, lecHours: 3, labHours: 0, totalHours: 3, prerequisites: ['BIO 101'] },
  { yearLevel: 1, semester: 2, courseCode: 'BIO 102L', subjectName: 'Biodiversity and Evolution Lab', lec: 0, lab: 2, totalUnits: 2, lecHours: 0, labHours: 6, totalHours: 6, prerequisites: ['BIO 101L'] },
  ...
  { yearLevel: 2, semester: 2, courseCode: 'ESC 202', subjectName: 'Soil Science Lec', lec: 3, lab: 0, totalUnits: 3, lecHours: 3, labHours: 0, totalHours: 3, prerequisites: ['ErS 102', 'CHE 201'] },
  ...
  { yearLevel: 3, semester: 1, courseCode: 'ESM 301', subjectName: 'Coastal Resource Management', lec: 3, lab: 0, totalUnits: 3, lecHours: 3, labHours: 0, totalHours: 3, prerequisites: ['GIS 201', 'GIS 201L'] },
  { yearLevel: 3, semester: 1, courseCode: 'ESC 301', subjectName: 'Aquatic and Terrestrial Ecosystem Sampling Techniques Lec', lec: 3, lab: 0, totalUnits: 3, lecHours: 3, labHours: 0, totalHours: 3, prerequisites: ['ESC 201'] },
  { yearLevel: 3, semester: 1, courseCode: 'ESC 301L', subjectName: 'Aquatic and Terrestrial Ecosystem Sampling Techniques Lab', lec: 0, lab: 1, totalUnits: 1, lecHours: 0, labHours: 3, totalHours: 3, prerequisites: [] },
  ...
  { yearLevel: 3, semester: 2, courseCode: 'ESM 302', subjectName: 'Environmental Monitoring Lec', lec: 3, lab: 0, totalUnits: 3, lecHours: 3, labHours: 0, totalHours: 3, prerequisites: ['CHE 202'] },
  { yearLevel: 3, semester: 2, courseCode: 'ESM 302L', subjectName: 'Environmental Monitoring Lab', lec: 0, lab: 1, totalUnits: 1, lecHours: 0, labHours: 3, totalHours: 3, prerequisites: [] },
  { yearLevel: 3, semester: 2, courseCode: 'ESM 303', subjectName: 'Natural Resource Valuation and Economics', lec: 3, lab: 0, totalUnits: 3, lecHours: 3, labHours: 0, totalHours: 3, prerequisites: ['ESM 301'] },
  { yearLevel: 3, semester: 2, courseCode: 'ESC 303', subjectName: 'Atmospheric Science', lec: 3, lab: 0, totalUnits: 3, lecHours: 3, labHours: 0, totalHours: 3, prerequisites: ['GIS 201'] },
  { yearLevel: 3, semester: 2, courseCode: 'PCM 301', subjectName: 'Water Pollution Control and Management', lec: 3, lab: 0, totalUnits: 3, lecHours: 3, labHours: 0, totalHours: 3, prerequisites: ['CHE 301'] },
  { yearLevel: 3, semester: 2, courseCode: 'PCM 302', subjectName: 'Air Pollution Control and Management', lec: 3, lab: 0, totalUnits: 3, lecHours: 3, labHours: 0, totalHours: 3, prerequisites: ['CHE 301'] },
  { yearLevel: 3, semester: 2, courseCode: 'PCM 303', subjectName: 'Pollution Management in Practice', lec: 3, lab: 0, totalUnits: 3, lecHours: 3, labHours: 0, totalHours: 3, prerequisites: ['CHE 301'] },
  ...
  { yearLevel: 4, semester: 1, courseCode: 'PCM 401', subjectName: 'Air Quality Management', lec: 3, lab: 0, totalUnits: 3, lecHours: 3, labHours: 0, totalHours: 3, prerequisites: ['PCM 301', 'PCM 302', 'PCM 303'] },
  { yearLevel: 4, semester: 1, courseCode: 'PCM 402', subjectName: 'Water Quality Management', lec: 3, lab: 0, totalUnits: 3, lecHours: 3, labHours: 0, totalHours: 3, prerequisites: ['PCM 301', 'PCM 302', 'PCM 303'] },
  { yearLevel: 4, semester: 1, courseCode: 'ESC 402', subjectName: 'Geological Hazards', lec: 3, lab: 0, totalUnits: 3, lecHours: 3, labHours: 0, totalHours: 3, prerequisites: ['GIS 201'] },
  { yearLevel: 4, semester: 1, courseCode: 'ESM 401', subjectName: 'Nature Based Solutions for Sustainable Development', lec: 3, lab: 0, totalUnits: 3, lecHours: 3, labHours: 0, totalHours: 3, prerequisites: ['ESM 303'] },
  ...
  { yearLevel: 4, semester: 2, courseCode: 'PCM 403', subjectName: 'Solid Waste Management and Environmental Health', lec: 3, lab: 0, totalUnits: 3, lecHours: 3, labHours: 0, totalHours: 3, prerequisites: ['PCM 401', 'PCM 402'] },
  { yearLevel: 4, semester: 2, courseCode: 'EIA 402', subjectName: 'Environmental Impact Assessment System', lec: 3, lab: 0, totalUnits: 3, lecHours: 3, labHours: 0, totalHours: 3, prerequisites: ['PCM 401', 'PCM 402', 'ESC 402', 'ESM 401'] },
  { yearLevel: 4, semester: 2, courseCode: 'ESM 402', subjectName: 'Environmental Policies and Standard', lec: 3, lab: 0, totalUnits: 3, lecHours: 3, labHours: 0, totalHours: 3, prerequisites: ['PCM 401', 'PCM 402', 'ESC 402', 'ESM 401'] },
...
async function seedBSEnviSciPCCurriculum() {
  try {
    console.log('Starting BS Environmental Science - Pollution Control curriculum seeding...');

    let program = await prisma.universityProgram.findUnique({
      where: { title: 'Bachelor of Science in Environmental Science With Specialization in Pollution Control and Management' }
    });

    if (!program) {
      console.log('Creating BS Environmental Science - Pollution Control program...');
      program = await prisma.universityProgram.create({
        data: {
          title: 'Bachelor of Science in Environmental Science With Specialization in Pollution Control and Management',
          abbreviation: 'BS Envi Sci (PC)',
    ...
    console.log('\n[OK] BS Environmental Science - Pollution Control curriculum seeding completed successfully!');

  } catch (error) {
    console.error('[ERROR] Error seeding BS Envi Sci PC curriculum:', error);
    throw error;
  } finally {
...
seedBSEnviSciPCCurriculum();

export { seedBSEnviSciPCCurriculum };
