...
const DigitalSerenityWithSummary: React.FC = () => {
  ...
  const animateFacultyEntrance = () => {
    gsap.killTweensOf([".faculty-slide-item", ".faculty-slide-image"]);
  ...
  useEffect(() => {
    ...
    // Multiple refresh attempts – covers slow image loading
    const refreshAttempts = [600, 1400, 2800, 4500].map((delay) =>
      setTimeout(() => {
        AOS.refresh();
        console.log(`AOS refreshed after ${delay}ms`);
      }, delay),
    );
    ...
    // Optional: log when elements actually get animated (debug helper)
    const checkAnimated = setInterval(() => {
      const animated = document.querySelectorAll(".aos-animate").length;
      if (animated > 0) {
        console.log(`Found ${animated} animated elements`);
      }
    }, 1500);

    return () => {
      refreshAttempts.forEach(clearTimeout);
      window.removeEventListener("resize", handleResize);
      clearInterval(checkAnimated);
    };
  }, []);
  ...
  useEffect(() => {
    ...
    }, 8000); // ← your current speed (5 seconds) — you can change this number anytime
  ...
  const facultySlides = [
    {
      ...
      description:
        "Overview of your classes, recent student activity, pending grading tasks, and quick links to course management tools.",
      icon: (
        <LayoutDashboard className="w-8 h-8 lg:w-10 lg:h-10 text-purple-400 flex-shrink-0 mt-1" />
      ),
      points: [
        "At-a-glance activity and unread items",
        "Pending grading and submissions",
        "Quick access to your courses and announcements",
        "Recent student interactions and flagged items",
        "Actionable teaching insights & recommendations",
      ],
    },
    {
      title: "Classroom Management",
      description:
        "Create and organize course content, manage enrollments, and configure classroom access and resources.",
      icon: (
        <Video className="w-8 h-8 lg:w-10 lg:h-10 text-purple-400 flex-shrink-0 mt-1" />
      ),
      points: [
        "Create/edit posts, announcements, and materials",
        "Upload and attach files or external links to lessons",
        "Create assignments with deadlines and rubrics",
        "Approve/reject join requests and manage rosters",
        "Moderate discussions and pin important resources",
      ],
    },
    {
      title: "Meetings & Scheduling",
      description:
        "Schedule classes, office hours, and consultations with optional calendar sync and automated reminders.",
      icon: (
        <Calendar className="w-8 h-8 lg:w-10 lg:h-10 text-purple-400 flex-shrink-0 mt-1" />
      ),
      points: [
        "Create meetings and office hours with join links",
        "Two-way Google Calendar sync (optional)",
        "View classroom-level schedules and availability",
        "Automatic email/in-app reminders for attendees",
        "Join or launch meetings from the platform",
      ],
    },
    {
      title: "AI-Powered Assessments",
      description:
        "Author quizzes and assessments with AI-assisted item generation, auto-grading, and analytics to spot class-wide gaps.",
      icon: (
        <Bot className="w-8 h-8 lg:w-10 lg:h-10 text-purple-400 flex-shrink-0 mt-1" />
      ),
      points: [
        "AI-assisted question generation and item bank",
        "Support for multiple question types and attachments",
        "Auto-grade objective items and annotate subjective answers",
        "Per-student and class-level analytics",
        "Actionable reports to address learning gaps",
      ],
    },
    {
      title: "Notifications & Communication",
      description:
        "Send targeted announcements, message student groups, and configure notification channels to reach learners effectively.",
      icon: (
        <Bell className="w-8 h-8 lg:w-10 lg:h-10 text-purple-400 flex-shrink-0 mt-1" />
      ),
      points: [
        "Targeted announcements to courses, sections, or specific students",
        "In-app messages and discussion threads",
        "Configurable email notification preferences",
        "Meeting reminders and reschedule alerts",
        "Exportable notification logs for auditing",
      ],
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Go to 'Browse Courses' from the main menu, open the course card, then click 'Enroll'. If the course requires approval the course page will show 'Request to Join' — after requesting, check 'My Courses' or the Notifications bell for approval updates.",
    },
    {
      question: "How does the AI Tutor work and how do I get the best answers?",
      answer:
        "The AI Tutor analyzes your question and course context to generate step‑by‑step help. Tip: include the course name, lesson/topic, and any attempted solution. For example: 'In BIO101, chapter 3 — how do I solve question 4? I tried X and got Y.'",
    },
    {
      question: "What languages does the AI Tutor support?",
      answer:
        "It supports English and Filipino. Ask in either language and the assistant will reply in the same language. For clearer responses, mention whether you want a short explanation, step-by-step solution, or examples.",
    },
    {
      question: "What devices and browsers are supported?",
      answer:
        "The platform works on modern browsers such as Chrome, Edge, Safari, and Firefox. It supports desktop, tablet, and mobile devices. For best performance, use the latest browser version and a stable internet connection.",
    },
    {
      question: "Does the system support dark mode or accessibility features?",
      answer:
        "Yes. Users can enable dark mode and adjust language settings from account preferences. The platform is designed for readability, including keyboard navigation and responsive layouts for different screen sizes.",
    },
    {
      question: "How do I complete a course?",
      answer:
        "Complete all required modules, assignments, and quizzes in the course. Once all requirements are met, the course will be marked as completed. If certificates are enabled by your institution, you can download it from the course completion page.",
    },
    {
      question: "How do classroom join requests and approvals work?",
      answer:
        "Students request to join from a class page. Teachers will see 'Join Requests' in the classroom settings and can approve or reject. Once approved, the student is added to the roster and receives a notification.",
    },
    {
      question: "How is my learning progress tracked and where can I see it?",
      answer:
        "Progress is tracked automatically (modules completed, quiz results, and time spent). Open 'My Courses' → select a course to view progress bars, recent scores, and recommended next steps based on your performance.",
    },
    {
      question: "How do I schedule or join meetings and sync with my calendar?",
      answer:
        "Create meetings from a course or the Meetings page. Use the 'Add to Calendar' or 'Sync with Google' option to enable two-way sync. Join links appear in the meeting details and under your personal calendar inside the platform.",
    },
    {
      question: "I'm not receiving notification emails — what should I check?",
      answer:
        "First check the in-app Notifications bell (top-right). Then verify your email in account settings and check spam/junk folders. If still missing, contact your administrator to confirm institutional email settings.",
    },
    {
      question: "How do I reset my password or recover access?",
      answer:
        "Click 'Forgot Password' on the login page to receive a reset link. If you don't receive it within a few minutes, check spam or ask your institution admin to verify your account email.",
    },
    {
      question: "How can I report bugs, request features, or get help?",
      answer:
        "Use the in-app 'Help' / 'Contact Support' to submit issues — include a brief description, steps to reproduce, and screenshots. For feature requests tied to your institution, speak with your admin to prioritize it.",
    },
    {
      question: "What data does the system collect and how is it used?",
      answer:
        "We collect account details, activity logs, and anonymized usage metrics to run and improve the platform. Personal data use follows your institution's privacy policy — contact your admin for deletion or export requests.",
    },
  ];
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentCsSlide((prev) => (prev + 1) % csSlides.length);
    }, 8000);
  ...
  // Hide floating / quick nav when hero section is visible
  useEffect(() => {
  ...
  return (
    <>
      <div className="min-h-screen bg-black text-white overflow-hidden relative">
        ...
        <div
          className="float-particle"
          style={{ top: "35%", left: "12%", animationDelay: "2s" }}
        ></div>
        <div
          className="float-particle"
          style={{ top: "85%", left: "80%", animationDelay: "3s" }}
        ></div>
        <div
          className="float-particle"
        ...
        <div
          className="float-particle"
          style={{ top: "60%", left: "25%", animationDelay: "6s" }}
        ></div>
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(103,232,249,0.3), transparent 70%)",
            ...mouseGradientStyle,
          }}
        />
        ...
        <div className="relative z-10">
          ...
          >
            <div className="max-w-7xl mx-auto w-full">
              <p className="text-cyan-400 text-lg font-light tracking-widest uppercase mb-8 text-center">
              ...
              <h1 className="text-7xl md:text-9xl font-black tracking-tighter text-center mb-8">
                <span
                  className="block bg-gradient-to-r from-cyan-400 via-indigo-400 to-purple-500 bg-clip-text text-transparent word-animate"
          ...
          <section
            id="MISSION-VISION"
            className="relative py-20 px-6 scroll-mt-0 overflow-hidden"
          >
            {csSlides.map((img, idx) => (
              <div
                key={idx}
                className={`absolute inset-0 bg-cover bg-center bg-no-repeat transition-opacity duration-1000 ${
                  idx === currentCsSlide ? "opacity-100" : "opacity-0"
                }`}
            ...
            >
              ...
              >
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Empowering every student in the College of Science and beyond
                  with intelligent, always-available academic support.
                </p>
              </div>
              ...
              <div className="mb-16">
                <h3
                  className="text-5xl font-bold text-center mb-6 text-cyan-300"
                  data-aos="fade-right"
                  data-aos-offset="100"
                ...
                <div
                  className="bg-black/50 backdrop-blur-sm rounded-2xl p-8 md:p-10 border border-cyan-500/20 shadow-xl"
                  data-aos="flip-right"
                  data-aos-delay="100"
                >
                  <p className="text-lg md:text-xl leading-relaxed text-gray-200 text-center">
                    To power the future of learning at Bulacan State University
                    with an AI academic companion that’s always available,
                    deeply personalized, and built for student success. We
                    envision a smarter campus where every College of Science
                    student gets instant guidance, makes confident academic
                    decisions, and thrives in a digitally connected learning
                    environment.
                  </p>
                </div>
              </div>
              ...
              <div>
                <h3
                  className="text-5xl font-bold text-center mb-8 text-purple-300"
                  data-aos="flip-right"
                  data-aos-delay="100"
                >
                  Mission
                ...
                <p
                  className="text-xl text-gray-300 text-center mb-10 max-w-4xl mx-auto"
                  data-aos="flip-right"
                  data-aos-delay="100"
                >
                  To deliver fast, reliable, and intelligent academic support so
                  students and educators can focus on what truly matters.
                </p>

                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div
                    className="bg-black/40 backdrop-blur-sm rounded-xl p-6 border border-red-500/30 hover:border-red-400/50 transition-all"
                    data-aos="zoom-in"
                  >
                    ...
                    <p className="text-gray-300">
                      24/7 AI-driven support that answers questions instantly
                      and removes academic friction.
                    </p>
                  </div>

                  <div
                    className="bg-black/40 backdrop-blur-sm rounded-xl p-6 border border-cyan-500/30 hover:border-cyan-400/50 transition-all"
                    data-aos="zoom-in"
                  >
                    ...
                    <p className="text-gray-300">
                      Smart recommendations and tailored guidance that help
                      students stay on track, stress less, and achieve more.
                    </p>
                  </div>

                  <div
                    className="bg-black/40 backdrop-blur-sm rounded-xl p-6 border border-purple-500/30 hover:border-purple-400/50 transition-all"
                    data-aos="zoom-in"
                  >
                    ...
                    <p className="text-gray-300">
                      Automates repetitive inquiries, freeing faculty to focus
                      on teaching, mentoring, and innovation.
                    </p>
                  </div>

                  <div
                    className="bg-black/40 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30 hover:border-indigo-400/50 transition-all"
                    data-aos="zoom-in"
                  >
                    ...
                    <p className="text-gray-300">
                      Enterprise-grade security and ethical AI ensure data
                      privacy, trust, and academic integrity.
                    </p>
                  </div>

                  <div
                    className="bg-black/40 backdrop-blur-sm rounded-xl p-6 border border-green-500/30 hover:border-green-400/50 transition-all md:col-span-2 lg:col-span-1"
                    data-aos="zoom-in"
                  >
                    ...
                    <p className="text-gray-300">
                      Designed to support every student anytime, anywhere
          ...
          <section className="min-h-screen py-20 px-6">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Explore the powerful features of our AI-powered learning
                  platform designed for students, teachers, and administrators.
                </p>
              </div>

              {/* Main Content */}
              <div id="SYSTEM-SUMMARY" className="space-y-16 scroll-mt-10">
                {/* AI Tutor Section */}
                <section id="ai-tutor" className="scroll-mt-20">
                  ...
                  >
                    ...
                    <h2 className="text-3xl font-bold">AI Chatbot Assistant</h2>
                  </div>

                  <div
                    className="bg-black/40 backdrop-blur-sm rounded-2xl p-8 border border-cyan-500/20"
                    data-aos="fade-left"
                    data-aos-offset="200"
                    data-aos-duration="300"
                  >
                    <div className="grid md:grid-cols-2 gap-8">
                      <div>
                        ...
                        <ul className="space-y-3">
                          <li className="flex items-start gap-3">
                            ...
                            <span>
                              24/7 Q&amp;A for College of Science topics,
                              policies, programs, and platform help
                            </span>
                          </li>
                          <li className="flex items-start gap-3">
                            <div className="w-6 h-6 bg-cyan-500/20 rounded-full flex items-center justify-center mt-1">
                            ...
                            <span>
                              Bilingual responses (English/Filipino) — replies
                          ...
                          <li className="flex items-start gap-3">
                            ...
                            <span>
                              Context-aware tutoring with step-by-step text
                              explanations for course/lesson questions
                            </span>
                          </li>
                          <li className="flex items-start gap-3">
                            <div className="w-6 h-6 bg-cyan-500/20 rounded-full flex items-center justify-center mt-1">
                            ...
                            <span>
                              AI-generated quizzes &amp; practice exams with
                              instant scoring and review
                            </span>
                          </li>
                          <li className="flex items-start gap-3">
                            <div className="w-6 h-6 bg-cyan-500/20 rounded-full flex items-center justify-center mt-1">
                            ...
                            <span>
                              Saved chat history with rename, star, and delete —
                              organize multiple conversations
                            </span>
                          </li>
                          <li className="flex items-start gap-3">
                            <div className="w-6 h-6 bg-cyan-500/20 rounded-full flex items-center justify-center mt-1">
                            ...
                            <span>
                              Smart greetings and follow-up suggestions to guide
                              your next questions
                            </span>
                          </li>
                        </ul>
                      ...
                      <div>
                        ...
                        <p className="text-gray-300">
                          Get precise answers about College of Science, receive
                          step-by-step explanations, and quickly generate
                          practice quizzes with instant results. Chats are saved
                          so you can rename or star important threads and
                          continue later. Text questions only (no file uploads).
                          Not a replacement for faculty guidance.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="grid md:grid-cols-2 gap-8">
                      <div>
                        ...
                        <ul className="space-y-3">
                          <li className="flex items-start gap-3">
                            ...
                            <span>
                              Courses, lessons, materials, and quizzes
                            </span>
                          </li>
                          <li className="flex items-start gap-3">
                            <div className="w-6 h-6 bg-purple-500/20 rounded-full flex items-center justify-center mt-1">
                            ...
                            <span>
                              Programs & curriculum (COS programs, mappings)
                            </span>
                          </li>
                          <li className="flex items-start gap-3">
                            <div className="w-6 h-6 bg-purple-500/20 rounded-full flex items-center justify-center mt-1">
                            ...
                            <span>
                              Classrooms: posts, comments, attachments, join
                              requests
                            </span>
                          </li>
                          <li className="flex items-start gap-3">
                            ...
                            <span>
                              Meetings/consultations with Google Calendar sync
                            </span>
                          </li>
                          <li className="flex items-start gap-3">
                            <div className="w-6 h-6 bg-purple-500/20 rounded-full flex items-center justify-center mt-1">
                            ...
                            <span>
                              Notifications, FAQs, and progress/analytics
                            </span>
                          </li>
                        </ul>
                      </div>
                      <div>
                        ...
                        <p className="text-gray-300">
                          The ILS unifies course delivery, classroom
                          collaboration, meetings, and assessments into one
                          workflow. Data is consistent across modules and shown
                          via role-based views for students, faculty, and
                          admins.
                        </p>
                      </div>
                    </div>
                ...
                <section id="user-accounts" className="scroll-mt-20">
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    {/* Student Card */}
                    <div
                      className="bg-black/40 backdrop-blur-sm rounded-2xl p-6 border border-blue-500/20"
                      data-aos="flip-left"
                    ...
                    >
                      ...
                      <ul className="space-y-3">
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-blue-400">•</span>
                          <span>Submit quizzes/practice exams</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-blue-400">•</span>
                          <span>Join classrooms and view posts/comments</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-blue-400">•</span>
                          <span>Chat with AI Tutor for COS help</span>
                        </li>
                      </ul>
                    </div>
                    ...
                    >
                      ...
                      <ul className="space-y-3">
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-red-400">•</span>
                          <span>
                            Manage programs, curriculum, courses, lessons
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-red-400">•</span>
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-red-400">•</span>
                          <span>
                            Create/manage courses, lessons, and quizzes
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-red-400">•</span>
                          <span>Content moderation and maintenance</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                {/* Student section */}
                <section id="STUDENTS" className="scroll-mt-0 py-16 md:py-24">
                  <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    ...
                    >
                      ...
                      <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-cyan-300 to-cyan-500 bg-clip-text text-transparent pb-1 md:pb-2">
                        ...
                        <div className="relative rounded-2xl overflow-hidden border border-cyan-500/30 shadow-2xl shadow-cyan-900/30 bg-black/60 backdrop-blur-md">
                          <div className="overflow-hidden">
                            <div
                              ...
                              style={{
                                transform: `translateX(-${currentStudentSlide * 100}%)`,
                              }}
                            >
                              <img
                ...
                <section
                  id="FACULTY"
                  className="scroll-mt-0 py-16 md:py-14 relative overflow-hidden"
                >
                  <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div
                      className="flex items-center gap-5 mb-10 md:mb-12"
                    ...
                    >
                      ...
                      <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-300 to-purple-500 bg-clip-text text-transparent pb-1 md:pb-2">
                    ...
                    {/* Slider container */}
                    <div
                      className="relative rounded-[3rem] overflow-hidden bg-black border-4 border-purple-900/30 shadow-2xl shadow-purple-950/50"
                      onMouseEnter={() => setIsFacultyHovered(true)} // ← pause when mouse enters
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          transform: `translateX(-${currentFacultySlide * 20}%)`,
                        }}
                      >
                          ...
                          >
                            ...
                            <div className="p-8 lg:p-12 xl:p-16 z-10">
                              <div className="flex items-start gap-5 mb-8 faculty-slide-item">
                                {slide.icon}
                                <div>
                                  <h4 className="font-bold text-purple-300 text-2xl lg:text-3xl">
                                    {slide.title}
                                  </h4>
                              ...
                              <ul className="space-y-6 text-lg lg:text-xl text-gray-200">
                                {slide.points.map((point, i) => (
                                  <li
                                    key={i}
                                    className="flex items-start gap-4 faculty-slide-item"
                                  >
                ...
                {/* Admin section  */}
                <section id="ADMINS" className="scroll-mt-0 py-16 md:py-14 ">
                  <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div
                      className="flex items-center gap-5 mb-10 md:mb-12"
                    ...
                    >
                      ...
                      <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-indigo-300 to-indigo-500 bg-clip-text text-transparent pb-1 md:pb-2">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                      {/* Feature list */}
                      <div
                        className="order-2 lg:order-1 space-y-8 text-lg leading-relaxed text-gray-200"
                        ...
                        <ul className="space-y-6">
                          <li className="flex items-start gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-gray-300 mt-1">
                                Real-time system metrics, active users, and key
                          ...
                          <li className="flex items-start gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-gray-300 mt-1">
                                Manage user accounts, roles, enrollments, and
                                data exports.
                              </p>
                            </div>
                          </li>
                          <li className="flex items-start gap-4">
                            ...
                            <div>
                              <h4 className="font-semibold text-indigo-300">
                                Rooms & Scheduling Infrastructure
                              </h4>
                              <p className="text-gray-300 mt-1">
                                Configure rooms, schedules, and booking rules
                          ...
                          <li className="flex items-start gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-gray-300 mt-1">
                                Centralized FAQs and knowledge base for users
                                and administrators.
                              </p>
                            </div>
                          </li>
                        ...
                        <div className="relative rounded-2xl overflow-hidden border border-indigo-500/30 shadow-2xl shadow-indigo-900/30 bg-black/60 backdrop-blur-md">
                          <div className="overflow-hidden">
                            <div
                              className="flex transition-transform duration-700 ease-out"
                              style={{
                                transform: `translateX(-${currentAdminSlide * 100}%)`,
                              }}
                            >
                              <img
                          ...
                          <button
                            onClick={() =>
                              setCurrentAdminSlide((prev) => (prev - 1 + 5) % 5)
                            }
                ...
                <section id="ADDITIONAL-FEATURES" className="scroll-mt-0">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-black/40 backdrop-blur-sm rounded-2xl p-6 border border-indigo-500/20">
                      ...
                      <p className="text-gray-300 mb-4">
                        Explore available courses with powerful filtering and
                        search capabilities:
                      </p>
                    ...
                    <div className="bg-black/40 backdrop-blur-sm rounded-2xl p-6 border border-pink-500/20">
                      ...
                      <p className="text-gray-300 mb-4">
                        Your personalized learning dashboard with all enrolled
                        courses:
                      </p>
                      <ul className="space-y-2">
                        <li className="flex items-center gap-2">
                ...
                <section id="FAQS" className="scroll-mt-20">
                  <div className="text-center mb-10">
                    ...
                    <p className="text-gray-400 max-w-2xl mx-auto">
                      Find quick answers to common questions about using the
                      TISA platform
                    </p>
                  </div>
          ...
          {!isHeroVisible && (
            <>
              ...
              <div className="fixed right-6 top-1/2 -translate-y-1/2 z-40 hidden md:flex">
                <div
                  className="flex flex-col gap-4 rounded-full px-3 py-4
