...
export default function CourseDetail() {
  ...
  const fetchCourseDetail = async () => {
    try {
      ...
      // IMPROVED: Use enrollment presence instead of isEnrolled field (more reliable)
  ...
  const handleEnroll = async () => {
    ...
    try {
      ...
      setIsEnrolled(true);
      // CHANGED: Customized message for admin vs student
      ...
      showToast({ type: 'success', title: 'Enrolled Successfully!', message });
      fetchCourseDetail(); // NEW: Refresh detail to update UI (enrolled state, counts, etc.)
    } catch (error: any) {
  ...
  // NEW: Show enroll button to both STUDENT and ADMIN
