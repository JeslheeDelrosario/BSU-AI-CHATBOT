...
const ACHIEVEMENT_TYPES = ['FIRST_COURSE','FIVE_COURSES','TEN_COURSES','COURSE_COMPLETION','PERFECT_SCORE','QUIZ_MASTER','STREAK','DEDICATED_LEARNER','CORRECT_ANSWERS_100','CORRECT_ANSWERS_500','MILESTONE','SPEED_LEARNER','EARLY_BIRD','NIGHT_OWL','HELPFUL_PEER','LEADERBOARD_TOP1','LEADERBOARD_TOP3','MODULE_COMPLETE'];
const REQUIREMENT_TYPES = [{value:'COURSE_COMPLETION',label:'Courses Completed'},{value:'LESSON_COMPLETION',label:'Lessons Completed'},{value:'CORRECT_ANSWERS',label:'Correct Answers'},{value:'PERFECT_SCORE',label:'Perfect Scores (100%)'},{value:'STREAK',label:'Day Streak'},{value:'ENROLLMENT',label:'Courses Enrolled'}];
